  ...
  return (
    <>
      <div className="page-title">
        <Breadcrumb
          items={[{ text: "Admin", link: "/admin" }, { text: "Markalar" }]}
        />
      </div>
      <div className="search_and_add mt-2 mb-2">
        ...
        />
        <Link href={"/admin/markalar/ekle"} className="btn btn-green">
          ...
          return (
            <li className="table-row" key={item.id}>
              ...
              <div className="col col-4" data-label="Operations">
                <Link href={`/admin/markalar/${item.id}`}>
                  <i
                ...
                >
                  {" "}
                  <span className="tooltiptext">Marka Sil</span>
                </i>
              </div>
            </li>
          );
