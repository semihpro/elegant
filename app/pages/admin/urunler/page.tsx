  ...
  return (
    <>
      ...
      <div className="search_and_add mt-2 mb-2">
        ...
        />
        <Link href={"/admin/urunler/ekle"} className="btn btn-green">
        ...
        {products.map((item) => {
          return (
            <li className="table-row" key={item.id}>
              <div className="col col-1" data-label="Rengi">
                {item.color.name}
              </div>
              <div className="col col-2" data-label="Adi">
                {item.name}
              </div>
              <div className="col col-3" data-label="Markasi">
                {item.brand.name}
              </div>
              <div className="col col-4" data-label="Resim">
                <img
                  src={item.image_path1 ? item.image_path1 : `/no-image.jpg`}
                  alt=""
                  width={"25px"}
                  height={"25px"}
                />
              ...
              <div className="col col-5" data-label="Islem">
                <Link href={`/admin/urunler/${item.id}`}>
                  <i
                    className="fa fa-pencil tooltip mouse-pointer"
                    aria-hidden="true"
                  >
                    {" "}
                    <span className="tooltiptext">Marka Düzenle</span>
                  </i>{" "}
                </Link>
                <i
                ...
                >
                  {" "}
                  <span className="tooltiptext">Markayi Sil</span>
                </i>
              </div>
            </li>
          );
